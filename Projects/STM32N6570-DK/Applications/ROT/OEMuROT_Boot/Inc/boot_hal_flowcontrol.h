...
#define FLOW_STEP_MPU_I_EN_R4       0x005176a3U      /*!< Step MPU Region 4 Init enable value */
#define FLOW_STEP_MPU_I_EN_R5       0x000154b5U      /*!< Step MPU Region 5 Init enable value */
#if (OEMUROT_LOAD_AND_RUN != NO_LOAD_AND_RUN)
#define FLOW_STEP_MPU_I_EN_R6       0x00018799U      /*!< Step MPU Region 6 Init enable value */
#define FLOW_STEP_MPU_I_EN_R7       0x00019987U      /*!< Step MPU Region 7 Init enable value */
#if (MCUBOOT_S_DATA_IMAGE_NUMBER == 1)
#define FLOW_STEP_MPU_I_EN_R8       0x0001b696U      /*!< Step MPU Region 8 Init enable value */
#else
#define FLOW_STEP_MPU_I_EN_R8       0x00000000U      /*!< No effect on control flow */
#endif /* MCUBOOT_S_DATA_IMAGE_NUMBER == 1 */
#if (MCUBOOT_NS_DATA_IMAGE_NUMBER == 1)
#define FLOW_STEP_MPU_I_EN_R9       0x000673eaU      /*!< Step MPU Region 9 Init enable value */
#else
...
#define FLOW_STEP_MCE1_AES_CFG_EN   0x0001e1e1U      /*!< Step MCE1 AES configuration enable value */
#define FLOW_STEP_MCE1_AES_EN       0x0001ffffU      /*!< Step MCE1 AES enable value */
...
#define FLOW_STEP_MCE2_AES_CFG_EN   0x00029cf6U      /*!< Step MCE2 AES configuration enable value */
#define FLOW_STEP_MCE2_AES_EN       0x00031a37U      /*!< Step MCE2 AES enable value */
...
#if (OEMUROT_LOAD_AND_RUN != NO_LOAD_AND_RUN)
#define FLOW_STEP_MPU_I_CH_R6       0x0003d7a2U      /*!< Step MPU Region 6 Init check value */
#define FLOW_STEP_MPU_I_CH_R7       0x0003dbc9U      /*!< Step MPU Region 7 Init check value */
#if (MCUBOOT_S_DATA_IMAGE_NUMBER == 1)
#define FLOW_STEP_MPU_I_CH_R8       0x00045afcU      /*!< Step MPU Region 8 Init check value */
#else
#define FLOW_STEP_MPU_I_CH_R8       0x00000000U      /*!< No effect on control flow */
#endif /* MCUBOOT_S_DATA_IMAGE_NUMBER == 1 */
#if (MCUBOOT_NS_DATA_IMAGE_NUMBER == 1)
#define FLOW_STEP_MPU_I_CH_R9       0x00036f63U      /*!< Step MPU Region 9 Init check value */
#else
...
#define FLOW_STEP_MCE1_CH_R1        0x000474dfU      /*!< Step MCE1 Region 1 Init check value */
#if defined(MCUBOOT_USE_HASH_REF)
#define FLOW_STEP_MCE1_CH_R2        0x0004a7f3U      /*!< Step MCE1 Region 2 Init check value */
#else
#define FLOW_STEP_MCE1_CH_R2        0x00000000U      /*!< No effect on control flow */
#endif /* MCUBOOT_USE_HASH_REF */
#if !defined(MCUBOOT_OVERWRITE_ONLY)
#define FLOW_STEP_MCE1_CH_R3        0x00037ce8U      /*!< Step MCE1 Region 3 Init check value */
#else
#define FLOW_STEP_MCE1_CH_R3        0x00000000U      /*!< No effect on control flow */
#endif /* !defined(MCUBOOT_OVERWRITE_ONLY) */

#define FLOW_STEP_MCE1_AES_CTX_CH   0x000660adU      /*!< Step MCE1 AES context setting check value */
#define FLOW_STEP_MCE1_AES_CFG_CH   0x000618cbU      /*!< Step MCE1 AES configuration check value */

#define FLOW_STEP_MCE2_CH_R1        0x000547edU      /*!< Step MCE2 Region 1 Init check value */

#define FLOW_STEP_MCE2_AES_CTX_CH   0x000569ceU      /*!< Step MCE2 AES context setting check value */
#define FLOW_STEP_MCE2_AES_CFG_CH   0x000577d0U      /*!< Step MCE2 AES configuration check value */

#ifdef OEMUROT_INTERNAL_TAMPER_ENABLE
#define FLOW_STEP_TAMP_INT_CH       0x00059407U      /*!< Step Tamper internal check value */
#define FLOW_STEP_TAMP_SEC_CH       0x0005b371U      /*!< Step Tamper secure mode check value */
#define FLOW_STEP_TAMP_PRIV_CH      0x0005ea07U      /*!< Step Tamper privilege mode check value */
#define FLOW_STEP_TAMP_CFG_CH       0x0005f04fU      /*!< Step Tamper secret erase check value */
#else
...
#ifdef OEMUROT_MPU_PROTECTION
#define FLOW_STEP_MPU_S_A_EN_R      0x0005953fU      /*!< Step MPU Secure Region Appli enable value */
#define FLOW_STEP_MPU_S_A_EN_R7     0x0005bae2U      /*!< Step MPU Secure Region 7 Appli enable value */
#define FLOW_STEP_MPU_S_A_EN_R10    0x0005c37aU      /*!< Step MPU Secure Region 10 Appli enable value */
#define FLOW_STEP_MPU_S_A_EN_R11    0x0005dd64U      /*!< Step MPU Secure Region 11 Appli enable value */
...
#define FLOW_STEP_MPU_S_A_EN_R7     0x00000000U      /*!< No effect on control flow */
#define FLOW_STEP_MPU_S_A_EN_R10    0x00000000U      /*!< No effect on control flow */
...
#define FLOW_STEP_MPU_S_A_CH_R7     0x00075778U      /*!< Step MPU Secure Region 7 Appli check value */
#define FLOW_STEP_MPU_S_A_CH_R10    0x000784feU      /*!< Step MPU Secure Region 10 Appli check value */
#define FLOW_STEP_MPU_S_A_CH_R11    0x0007b621U      /*!< Step MPU Secure Region 11 Appli check value */
...
#define FLOW_STEP_MPU_S_A_CH_R7     0x00000000U      /*!< No effect on control flow */
#define FLOW_STEP_MPU_S_A_CH_R10    0x00000000U      /*!< No effect on control flow */
...
#define FLOW_CTRL_MPU_S_I_EN        (FLOW_CTRL_MPU_I_EN_R9 ^ FLOW_STEP_MPU_S_I_EN)
...
#define FLOW_CTRL_MCE1_AES_EN       (FLOW_CTRL_MCE1_AES_CFG_EN ^ FLOW_STEP_MCE1_AES_EN)

#define FLOW_CTRL_MCE2_EN_R1        (FLOW_CTRL_MCE1_AES_EN ^ FLOW_STEP_MCE2_EN_R1)
...
#define FLOW_CTRL_MCE2_AES_EN       (FLOW_CTRL_MCE2_AES_CFG_EN ^ FLOW_STEP_MCE2_AES_EN)

#define FLOW_CTRL_TAMP_INT_EN       (FLOW_CTRL_MCE2_AES_EN ^ FLOW_STEP_TAMP_INT_EN)
...
#define FLOW_CTRL_MPU_S_I_CH        (FLOW_CTRL_MPU_I_CH_R9 ^ FLOW_STEP_MPU_S_I_CH)
...
#define FLOW_CTRL_MCE2_CH_R1        (FLOW_CTRL_MCE1_AES_CFG_CH ^ FLOW_STEP_MCE2_CH_R1)
...
#define FLOW_CTRL_TAMP_INT_CH       (FLOW_CTRL_MCE2_AES_CFG_CH ^ FLOW_STEP_TAMP_INT_CH)
...
#define FLOW_CTRL_MPU_S_A_EN_R      (FLOW_CTRL_STAGE_2 ^ FLOW_STEP_MPU_S_A_EN_R)
#define FLOW_CTRL_MPU_S_A_EN_R7     (FLOW_CTRL_MPU_S_A_EN_R ^ FLOW_STEP_MPU_S_A_EN_R7)
#define FLOW_CTRL_MPU_S_A_EN_R10    (FLOW_CTRL_MPU_S_A_EN_R7 ^ FLOW_STEP_MPU_S_A_EN_R10)
#define FLOW_CTRL_MPU_S_A_EN_R11    (FLOW_CTRL_MPU_S_A_EN_R10 ^ FLOW_STEP_MPU_S_A_EN_R11)
#define FLOW_CTRL_MPU_NS_A_EN_R0    (FLOW_CTRL_MPU_S_A_EN_R11 ^ FLOW_STEP_MPU_NS_A_EN_R0)
...
#define FLOW_CTRL_OTP_NVCNT_EN      (FLOW_CTRL_MPU_NS_A_EN_R3 ^ FLOW_STEP_OTP_NVCNT_EN)
...
#define FLOW_CTRL_MPU_S_A_CH_R      (FLOW_CTRL_STAGE_3 ^ FLOW_STEP_MPU_S_A_CH_R)
#define FLOW_CTRL_MPU_S_A_CH_R7     (FLOW_CTRL_MPU_S_A_CH_R ^ FLOW_STEP_MPU_S_A_CH_R7)
#define FLOW_CTRL_MPU_S_A_CH_R10    (FLOW_CTRL_MPU_S_A_CH_R7 ^ FLOW_STEP_MPU_S_A_CH_R10)
#define FLOW_CTRL_MPU_S_A_CH_R11    (FLOW_CTRL_MPU_S_A_CH_R10 ^ FLOW_STEP_MPU_S_A_CH_R11)
#define FLOW_CTRL_MPU_NS_A_CH_R0    (FLOW_CTRL_MPU_S_A_CH_R11 ^ FLOW_STEP_MPU_NS_A_CH_R0)
...
#define FLOW_CTRL_OTP_NVCNT_CH      (FLOW_CTRL_MPU_NS_A_CH_R3 ^ FLOW_STEP_OTP_NVCNT_CH)
